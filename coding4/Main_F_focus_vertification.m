...
% Geo.tau =logspace(0,0.477,500)-1;
% 
% Geo.kappa=(2/3)./Geo.h;
...
suptitle('Spectrum of L \kappa=2/3,h=1,k=1.75,\tau=[0,2],m=[-5:5],n=[1:3]');
for kh=1
    ...
    plot(real(Lambda_H1),Geo_b.tau(kh)*ones(size(Lambda_H1)),'MarkerSize',1,'Marker','x','LineWidth',0.15,'LineStyle','none',...
        'Color',[1 0 0]);hold on;ylabel('real')
    %ylim([-10 10]);
    subplot(4,6,[19 20]);grid on
    plot(imag(Lambda_H1),Geo_b.tau(kh)*ones(size(Lambda_H1)),'MarkerSize',1,'Marker','x','LineWidth',0.15,'LineStyle','none',...
        'Color',[1 0 0]);hold on;ylabel('imag')
    %ylim([-10 10]);
    subplot(4,6,[15 16]);grid on
    plot(real(Lambda_H2),Geo_b.tau(kh)*ones(size(Lambda_H2)),'MarkerSize',1,'Marker','x','LineWidth',0.15,'LineStyle','none',...
        'Color',[1 0 0]);hold on;ylabel('real')
    %ylim([-10 10]);
    subplot(4,6,[21 22]);grid on
    plot(imag(Lambda_H2),Geo_b.tau(kh)*ones(size(Lambda_H2)),'MarkerSize',1,'Marker','x','LineWidth',0.15,'LineStyle','none',...
        'Color',[1 0 0]);hold on;ylabel('imag')
    %ylim([-10 10]);
    subplot(4,6,[17 18]);grid on
    plot(real(Lambda_H3),Geo_b.tau(kh)*ones(size(Lambda_H3)),'MarkerSize',1,'Marker','x','LineWidth',0.15,'LineStyle','none',...
        'Color',[1 0 0]);hold on;ylabel('real')
    %ylim([-10 10]);
    subplot(4,6,[23 24]);grid on
    plot(imag(Lambda_H3),Geo_b.tau(kh)*ones(size(Lambda_H3)),'MarkerSize',1,'Marker','x','LineWidth',0.15,'LineStyle','none',...
        'Color',[1 0 0]);hold on;ylabel('imag')
...
for kh=2:length(Geo_b.h)
    ...
    subplot(4,6,[13 14]);grid on
    plot(real(Lambda_H1),Geo_b.tau(kh)*ones(size(Lambda_H1)),'MarkerSize',0.2,'Marker','.','LineWidth',0.15,'LineStyle','none',...
        'Color',[0 0 0]);hold on;ylabel('real')
    %ylim([-10 10]);
    subplot(4,6,[19 20]);grid on
    plot(imag(Lambda_H1),Geo_b.tau(kh)*ones(size(Lambda_H1)),'MarkerSize',0.2,'Marker','.','LineWidth',0.15,'LineStyle','none',...
        'Color',[0 0 0]);hold on;ylabel('imag')
    %ylim([-10 10]);
    subplot(4,6,[15 16]);grid on
    plot(real(Lambda_H2),Geo_b.tau(kh)*ones(size(Lambda_H2)),'MarkerSize',0.2,'Marker','.','LineWidth',0.15,'LineStyle','none',...
        'Color',[0 0 0]);hold on;ylabel('real')
    %ylim([-10 10]);
    subplot(4,6,[21 22]);grid on
    plot(imag(Lambda_H2),Geo_b.tau(kh)*ones(size(Lambda_H2)),'MarkerSize',0.2,'Marker','.','LineWidth',0.15,'LineStyle','none',...
        'Color',[0 0 0]);hold on;ylabel('imag')
    %ylim([-10 10]);
    subplot(4,6,[17 18]);grid on
    plot(real(Lambda_H),Geo_b.tau(kh)*ones(size(Lambda_H)),'MarkerSize',0.2,'Marker','.','LineWidth',0.15,'LineStyle','none',...
        'Color',[0 0 0]);hold on;ylabel('real')
    %ylim([-10 10]);
    subplot(4,6,[23 24]);grid on
    plot(imag(Lambda_H3),Geo_b.tau(kh)*ones(size(Lambda_H3)),'MarkerSize',0.2,'Marker','.','LineWidth',0.15,'LineStyle','none',...
        'Color',[0 0 0]);hold on;ylabel('imag')
