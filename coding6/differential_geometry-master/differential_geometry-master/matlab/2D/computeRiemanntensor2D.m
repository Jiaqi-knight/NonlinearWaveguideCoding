function[Riemanntensor]=computeRiemanntensor2D(N,deltaq,secondChristoffelsymbol,metriccoefficients,firstdevneighbours)
...
Riemanntensor2111 = g12.*R1111 + g22.*R2111;
Riemanntensor2112 = g12.*R1112 + g22.*R2112;
Riemanntensor2121 = g12.*R1121 + g22.*R2121;
Riemanntensor2122 = g12.*R1122 + g22.*R2122;
Riemanntensor2211 = g12.*R1211 + g22.*R2211;
Riemanntensor2212 = g12.*R1212 + g22.*R2212;
Riemanntensor2221 = g12.*R1221 + g22.*R2221;
Riemanntensor2222 = g12.*R1222 + g22.*R2222;
