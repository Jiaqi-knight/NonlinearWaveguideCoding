...
% rho(1:half) = 3;
% rho(half+1:end) = 1;
rho(half-2:half+2,half-2:half+2)=0.01;
...
ux = sum(permute(scheme(:,1),[2,3,1]).*populations,3)./rho;
uy = sum(permute(scheme(:,2),[2,3,1]).*populations,3)./rho;
