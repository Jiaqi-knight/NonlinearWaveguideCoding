...
// Lattice indices for refined region on level L0 start numbering at 0
	...
	#elif NumReg == 1
	static size_t RefXstart[NumReg]		= {5};
	static size_t RefXend[NumReg]		= {10};
	static size_t RefYstart[NumReg]		= {5};
	static size_t RefYend[NumReg]		= {11};
	static size_t RefZstart[NumReg]		= {6};
	static size_t RefZend[NumReg]		= {8};
	#endif
