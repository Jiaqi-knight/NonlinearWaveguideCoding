...
%f(Nr/2, Mc/2,:) = rho_l;
%f(3:60, 3, 9) = 1 + rho_l*10;

[vec1, vec2,vec3,vec4,vec5,vec6,vec7,vec8,] = crossing3(Nr, Mc,[2 2 251 251 2], [2 61 61 2 2]);
%Block 5
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for ta = 1 : 100*150*sqrt(3)
    ...
    source_sound = 1 + 0.001*sin(2*pi*0.0001*(ta - 1)*Dt);
    f(Nr/2, Mc/2, 9) = source_sound;
