...
% 4 - Build lattice struct with D1Q3 (lattice = 1 x X)
lattice = build_lattice_D1Q3(number_columns_lattice, lattice_average_density);

% % 4.1 - Setting conditions of wall
% wall_points{1} = [251 2 2 251]; % set points in horizontal
% % wall_points{2} = [2 2 61 61]; % set points in vertical
