function[secondChristoffelsymbol]=computesecondChristoffelsymbol3Dsurface(N,deltaq,covariantbase,contravariantbase,firstdevneighbours)
...
secondChristoffelsymbol = [sum(g1d1.*G1,2) sum(g1d2.*G1,2) sum(g2d1.*G1,2) sum(g2d2.*G1,2)...
