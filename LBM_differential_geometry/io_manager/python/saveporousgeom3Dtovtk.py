...
@function
def saveporousgeom3Dtovtk(date=None,i=None,itmax=None,baseoutfilename=None,latticefolder=None,meshfolder=None,flags=None,N=None,Nx=None,Ny=None,Nz=None,lattice=None,spin=None,*args,**kwargs):
    varargin = saveporousgeom3Dtovtk.varargin
    nargin = saveporousgeom3Dtovtk.nargin
