...
@function
def saveporousgeom2Dtovtk(date=None,i=None,itmax=None,baseoutfilename=None,latticefolder=None,meshfolder=None,flags=None,N=None,Nx=None,Ny=None,lattice=None,spin=None,*args,**kwargs):
    varargin = saveporousgeom2Dtovtk.varargin
    nargin = saveporousgeom2Dtovtk.nargin
