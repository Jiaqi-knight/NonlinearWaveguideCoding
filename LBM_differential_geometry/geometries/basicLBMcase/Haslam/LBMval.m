...
%rather than the mathematics for which TDAs were proposed, is generally neither achievable nor required.
...
figure;plot(arrindices,EXACT);hold on; plot(arrindices,CALC,'or');
