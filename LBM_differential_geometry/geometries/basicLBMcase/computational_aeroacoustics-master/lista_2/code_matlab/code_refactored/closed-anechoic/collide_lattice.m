function lattice = collide_lattice(lattice, frequency_relaxation, sigma_mat9, Ft);
    ...
    f=lattice{1};
    lattice{1} = frequency_relaxation*feq +(1-frequency_relaxation)*f - sigma_mat9.*(feq- Ft);