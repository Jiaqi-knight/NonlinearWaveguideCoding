/**
        Project: Geometry of Fluid Flow
...
int main(int argc, char** argv)
{
    ...
    "\nDifferential Geometry-based Lattice Boltzmann Solver.\n\nFluid flow simulations in 2D and 3D.\n\nAllowed arguments");
    ...
    //lbm.initialize(inpfilename);
    
    //lbm.read_coordinates();
