...
int main(int argc, char** argv)
{
    ...
    "\nDifferential geometry tools.\n\nThe program provides tools for the differential geometry analysis of manifolds in 2D and 3D.\n\nAllowed arguments");
    ...
    diffgeom manifold(runmode);
    
    manifold.initialize(inpfilename);
    
    manifold.read_coordinates();
