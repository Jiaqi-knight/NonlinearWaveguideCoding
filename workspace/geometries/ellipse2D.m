function ell=ellipse(ra,rb,ang,x0,y0,Nb)
% Ellipse adds ellipses to the current plot
%
% ELLIPSE(ra,rb,x0,y0,ang) adds an ellipse with semimajor axis of ra,
...
for k=1:maxk
  ...
  ell(:,1)=radm*cos(the)*co-si*radn*sin(the)+xpos;
  ell(:,2)=radm*cos(the)*si+co*radn*sin(the)+ypos;
