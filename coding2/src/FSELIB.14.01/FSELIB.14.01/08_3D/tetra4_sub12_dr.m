...
% tetra4_sub12_dr
%
% driver for subdividing a 4-node tetrahedron
...
% arbitrary vertex coordinates:
 ...
 x(1) = 0.0; y(1)= 0.0; z(1)= 0.0;
 x(2) = 0.9; y(2)= 0.0; z(2)= 0.0;
 x(3) =-0.1; y(3)= 1.1; z(3)= 0.0;
 x(4) =-0.3; y(4)=-0.2; z(4)= 1.2;
...
%---
 ...
 vol(9) =tetra4_vis (x9, y9, z9, f9, option);pause(wait);
 vol(10)=tetra4_vis (x10,y10,z10, f10, option);pause(wait);
 vol(11)=tetra4_vis (x11,y11,z11, f11, option);pause(wait);
 vol(12)=tetra4_vis (x12,y12,z12, f12, option);
...
%--------
% visualize the individual elements
%--------
 ...
 % axis([0 1 0 1 0 1])
   ...
   elseif(i==9)
     vol(9) = tetra4_vis (x9, y9, z9, f9, option);
   elseif(i==10)
     vol(10) = tetra4_vis (x10, y10, z10, f10, option);
   elseif(i==11)
     vol(11) = tetra4_vis (x11, y11, z11, f11, option);
   elseif(i==12)
     vol(12) = tetra4_vis (x12, y12, z12, f12, option);
   end
 end
