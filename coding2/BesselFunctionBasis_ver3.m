...
subfunction_path2='.\src\chebfun-master'
...
psi_alpha_beta_r=delta_X_r.*Theta2;
psi_alpha_beta_rcos_phi=delta_X_r.*Theta2_cos_phi;
psi_alpha_beta_r2cos_phi=delta_X_r2.*Theta2_cos_phi;
psi_alpha_beta_r2sin_phi=delta_X_r2.*Theta2_sin_phi;
psi_pt_alpha_beta_r=delta_X_r.*Theta2_pt;
...
subplot(2,3,2);image(real(Theta2),'CDataMapping','scaled');grid on;axis equal;axis off;title('\Theta_{\alpha\beta}')
...
subplot(2,3,5);image(imag(Theta2),'CDataMapping','scaled');grid on;axis equal;axis off;title('\Theta_{\alpha\beta}')
subplot(2,3,4);image(imag(psi_alpha_beta_r),'CDataMapping','scaled');grid on;axis equal;axis off;title('imag(\Psi_{\alpha\beta}[r])=')

figure(2);
subplot(2,3,3);image(real(delta_X_r),'CDataMapping','scaled');grid on;axis equal;axis off;title('X_{\alpha\beta}[r]')
subplot(2,3,2);image(real(Theta2_cos_phi),'CDataMapping','scaled');grid on;axis equal;axis off;title('\Theta_{\alpha\beta}[cos\phi]')
...
subplot(2,3,6);image(imag(delta_X_r),'CDataMapping','scaled');grid on;axis equal;axis off;title('X_{\alpha\beta}[r]')
subplot(2,3,5);image(imag(Theta2_cos_phi),'CDataMapping','scaled');grid on;axis equal;axis off;title('\Theta_{\alpha\beta}[cos\phi]')
...
figure(4);
subplot(2,3,3);image(real(delta_X_r2),'CDataMapping','scaled');grid on;axis equal;axis off;title('X_{\alpha\beta}[r^2]')
subplot(2,3,2);image(real(Theta2_sin_phi),'CDataMapping','scaled');grid on;axis equal;axis off;title('\Theta_{\alpha\beta}[sin\phi]')
...
subplot(2,3,6);image(imag(delta_X_r2),'CDataMapping','scaled');grid on;axis equal;axis off;title('X_{\alpha\beta}[r^2]')
subplot(2,3,5);image(imag(Theta2_sin_phi),'CDataMapping','scaled');grid on;axis equal;axis off;title('\Theta_{\alpha\beta}[sin\phi]')
...
figure(5);
subplot(2,3,3);image(real(delta_X_r),'CDataMapping','scaled');grid on;axis equal;axis off;title('X_{\alpha\beta}[r]')
subplot(2,3,2);image(real(Theta2_pt),'CDataMapping','scaled');grid on;axis equal;axis off;title('\Theta_{(\alpha)\beta}')
...
subplot(2,3,6);image(imag(delta_X_r),'CDataMapping','scaled');grid on;axis equal;axis off;title('X_{\alpha\beta}[r]')
subplot(2,3,5);image(imag(Theta2_pt),'CDataMapping','scaled');grid on;axis equal;axis off;title('\Theta_{(\alpha)\beta}')
