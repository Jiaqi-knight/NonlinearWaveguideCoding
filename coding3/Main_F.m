...
% Geo.s=Geo.s(end);
% Geo.h=Geo.h(end);
% Geo.kappa=Geo.kappa(end)
% Geo.tau=Geo.tau(end);
% Geo.h_diff=Geo.h_diff(end);
%% #######Name########%
Name.op_m={'1','r','r2'};
...
Psi.ab_s1= specialFun(Geo_b.s,Geo_b.h,Geo_b.kappa,Geo_b.m,Geo_b.n,Base.Cmn1,Base.jmn_pm,'hh`^2/[1-\kappa*h*cos\psi]');
Psi.ab_s2= specialFun(Geo_b.s,Geo_b.h,Geo_b.kappa,Geo_b.m,Geo_b.n,Base.Cmn1,Base.jmn_pm,'h(1-\kappa*h*cos\psi)');
