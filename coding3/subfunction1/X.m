...
function [X2]= X(Base,Geo,dimention,op,op_m);
        ...
        X2=  deltaJ(Geo.s,Geo.h,Geo.h_diff,Base.Cmn1,Base.jmn_pm,Geo.m,Geo.n,dimention,0,op,op_m)...
            +deltaJ(Geo.s,Geo.h,Geo.h_diff,Base.Cmn1,Base.jmn_pm,Geo.m,Geo.n,dimention,1,op,op_m)...
            +deltaJ(Geo.s,Geo.h,Geo.h_diff,Base.Cmn1,Base.jmn_pm,Geo.m,Geo.n,dimention,-1,op,op_m);
end