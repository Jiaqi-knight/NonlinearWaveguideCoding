...
\begin{equation}
\begin{aligned}
N_{\alpha\beta}^a {\widehat{\textbf{I}_{\beta \alpha}^a}}^{-1}  Y_{\alpha\beta}^{\pm a} p_{\beta}^{\pm a}=(p_{\beta}^{\pm a})':=\\
NY^{\pm} \sum_{k=1}^\infty(c_k^{\pm}v_k e^{\pm i\lambda_ks})=[\sum_{k=1}^\infty(c_k^{\pm}v_k e^{\pm i\lambda_ks})]'\\
NY^{\pm} \sum_{k=1}^\infty(c_k^{\pm}v_k e^{\pm i\lambda_ks})=\pm  \sum_{k=1}^\infty(i\lambda_k c_k^{\pm}v_k e^{\pm i\lambda_ks})\\
\end{aligned}
\end{equation}
