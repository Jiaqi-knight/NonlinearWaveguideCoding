...
\Rightarrow   Y_{\alpha\beta}^{\pm a}=\pm   {\widehat{\textbf{I}_{ \alpha \beta}^a}} {N_{\beta \alpha}^a}^{-1} V\Lambda V^{-1}{\widehat{\textbf{I}_{ \alpha \beta}^a}}=\pm {\widehat{\textbf{I}_{ \alpha \beta}^a}} {N_{\beta \alpha}^a}^{-1} \sqrt{V\Lambda^2 V^{-1}}{\widehat{\textbf{I}_{ \alpha \beta}^a}}=\pm {\widehat{\textbf{I}_{ \alpha \beta}^a}} {N_{\beta \alpha}^a}^{-1} \sqrt{ \textbf{N}_{\alpha\beta}^a  {\widehat{\textbf{I}_{\beta \alpha}^a}}^{-1} \textbf{M}_{\alpha\beta}^a{\widehat{\textbf{I}_{\beta \alpha}^a}}^{-1}}{\widehat{\textbf{I}_{ \alpha \beta}^a}}
\end{aligned}
\end{equation}
...
+{W^{-1}}_{\xi\alpha}^a \mathcal{B}_{\alpha\beta\gamma}^{ab}[V_{\beta\delta}^{a-b} ,I_{\gamma\epsilon}V_{\gamma\epsilon}^{b} ])
\end{aligned}
\end{equation}
