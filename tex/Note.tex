...
\begin{equation}
\begin{aligned}
\int_0^{2\pi} e^{im\theta}e^{im\theta}  d\theta=0\\
\int_0^{2\pi} e^{im\theta}e^{-im\theta}  d\theta=2\pi\\
\end{aligned}
\end{equation}
...
Thus, with $\int_0^{2\pi} e^{im\theta}e^{-im\theta}  d\theta=2\pi$,
...
With $\int_0^{2\pi} e^{im\theta}e^{-im\theta}  d\theta=2\pi$,
$\psi_{\alpha_{m\mu}}(r)=C_{\alpha_{m\mu}}J_m({{j'}_{m\mu} r\over h})e^{im\phi}$,we have:
\begin{equation}
\begin{aligned}
C_{\alpha_{m\mu}}={1\over \sqrt{({{\pi h^2}(1-{m^2\over {j'}_{m\mu}^2} )}J^2_m({j'}_{m\mu}))}}\\
