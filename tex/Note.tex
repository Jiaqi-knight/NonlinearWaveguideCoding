...
\begin{equation}
\begin{aligned}
V_\alpha^a ={1\over {i a \kappa}}[\int_0^{2\pi}[r\psi_\alpha\psi_\beta]_0^h d\theta P_\beta^a-\Psi_{\alpha\beta}- \Psi_{[\alpha]\beta}[r]]P_\beta^a=V_{\alpha\beta}^a P_\beta^a
\end{aligned}
\end{equation}

\begin{equation}
\begin{aligned}
W_\alpha^a =-{1\over {i a \kappa}}\Psi_{(\alpha)\beta}P_\beta^a=W_{\alpha\beta}^a P_\beta^a
\end{aligned}
\end{equation}
