...
={\partial \over \partial s} V_\beta^a\delta_{\alpha\beta}-\int_0^{2\pi}{{h'}^2\over {1-\kappa h cos\phi}}[r \psi_\beta \psi_\alpha ]_0^h d\theta U_\beta^a -\Psi_{\{\alpha\}\beta}[r]V_\beta^a\\
={\partial \over \partial s}\int_0^{2\pi}\int_0^h [V_\beta^a \psi_\beta r  \psi_\alpha ]  dr d\theta-\int_0^{2\pi}{dh(s)\over ds} [V_\beta^a \psi_\beta r  \psi_\alpha ]_0^h d\theta
-\int_0^{2\pi}\int_0^h {\partial  \psi_\alpha  \over \partial s}   \psi_\beta r  dr d\theta V_\beta^a\\
={d \over d s} V_\alpha^a-\int_0^{2\pi}{{h'}^2\over {1-\kappa h cos\phi}}[r \psi_\beta \psi_\alpha ]_0^h d\theta U_\beta^a -\Psi_{\{\alpha\}\beta}[r]V_\beta^a\\
\\
...
\begin{equation}
\begin{aligned}
\uuline{{d \over ds} V_\alpha^a=\int_0^{2\pi}{{h'}^2\over {1-\kappa h cos\phi}}[r \psi_\beta \psi_\alpha ]_0^h d\theta U_\beta^a +\Psi_{\{\alpha\}\beta}[r]V_\beta^a}\\
...
+\sum_{b=-\infty}^{+\infty}\Psi_{\alpha\beta\gamma}[r]  \Psi_{(\alpha)\beta}[1-\kappa r cos\phi]u_\beta^a u_\beta^{a-b}  \rightarrow \mathcal{A}_{3.1}\\ 
...
\begin{equation}
\begin{aligned}
{u'}_\alpha^a+\textbf{M}_{\alpha\beta}^a p_\beta^a + \textbf{G}_{\alpha\beta}^a u_\beta^a=\mathcal{A}[u,u]+\mathcal{B}[p,p]+\varepsilon[u,p]\\
{p'}_\alpha^a-\textbf{N}_{\alpha\beta}^a u_\beta^a-\textbf{H}_{\alpha\beta}^a p_\beta^a=\mathcal{C}[u,p]+\mathcal{D}[u,u]
\end{aligned}
\end{equation}
...
\begin{equation}
\begin{aligned}
\psi_{\alpha_{m\mu}}(r)=C_{\alpha_{m\mu}}J_m({{j'}_{m\mu} r\over h})e^{im\theta}
\end{aligned}
\end{equation}
...
\Theta_{\alpha(\beta)\gamma}=\int_0^{2\pi} e^{im\theta} {d\over d\theta} (e^{in\theta}) e^{ik\theta} d\theta
\end{aligned}
\end{equation}
...
\begin{equation}
\begin{aligned}
\Theta_{\alpha\beta}=\int_0^{2\pi} e^{im\theta} e^{in\theta} d\theta=\left\{\begin{matrix}
0\\
2\pi, m+n=0
\end{matrix}\right.
=2\pi \delta_{m,-n}
...
\begin{equation}
\begin{aligned}
\Theta_{\alpha\beta}[cos\phi]=\int_0^{2\pi} cos(\theta-\theta_0) e^{im\theta} e^{in\theta} d\theta=1/2\int_0^{2\pi} [e^{i(\theta-\theta_0)}+e^{-i(\theta-\theta_0)}] e^{im\theta} e^{in\theta} d\theta\\
=1/2\int_0^{2\pi} e^{i(\theta-\theta_0)} e^{im\theta} e^{in\theta} d\theta+1/2\int_0^{2\pi} [e^{-i(\theta-\theta_0)}] e^{im\theta} e^{in\theta} d\theta\\
=\pi e^{-i\theta_0}\delta_{m,-n-1}+\pi e^{i\theta_0}\delta_{m,-n+1}
\end{aligned}
\end{equation}
...
\begin{equation}
\begin{aligned}
\Theta_{(\alpha)\beta}=\int_0^{2\pi} {\partial \over \partial \theta}(e^{im\theta}) e^{in\theta} d\theta
=2\pi im \delta_{m,-n}
\end{aligned}
\end{equation}
...
\begin{equation}
\begin{aligned}
\Theta_{(\alpha)\beta}[cos\phi]=im[ \pi e^{-i\theta_0}\delta_{m,-n-1}+\pi e^{i\theta_0}\delta_{m,-n+1}]
\end{aligned}
\end{equation}

\begin{equation}
\begin{aligned}
\Theta_{\alpha\beta\gamma}=\int_0^{2\pi} e^{im\theta} e^{in\theta}  e^{ik\theta} d\theta
=2\pi \delta_{m,-n-k}
\end{aligned}
\end{equation}
...
\begin{equation}
\begin{aligned}
\Theta_{\alpha\beta\gamma}[cos\phi]=1/2 \int_0^{2\pi} [e^{i(\theta-\theta_0)}+e^{-i(\theta-\theta_0)}]  e^{im\theta} e^{in\theta}  e^{ik\theta} d\theta
=\pi e^{-i\theta_0}\delta_{m,-n-k-1}+\pi e^{i\theta_0}\delta_{m,-n-k+1}
\end{aligned}
\end{equation}
...
\begin{equation}
\begin{aligned}
\Theta_{\alpha\beta\gamma}[sin\phi]=1/2i \int_0^{2\pi} [e^{i(\theta-\theta_0)}-e^{-i(\theta-\theta_0)}]  e^{im\theta} e^{in\theta}  e^{ik\theta} d\theta
=-i[\pi e^{-i\theta_0}\delta_{m,-n-k-1}-\pi e^{i\theta_0}\delta_{m,-n-k+1}]
\end{aligned}
\end{equation}

\begin{equation}
\begin{aligned}
\Theta_{(\alpha)\beta\gamma}=im \int_0^{2\pi} e^{im\theta} e^{in\theta}  e^{ik\theta} d\theta
...
\begin{aligned}
\Theta_{(\alpha)\beta\gamma}[cos\phi]=1/2 \int_0^{2\pi} [e^{i(\theta-\theta_0)}+e^{-i(\theta-\theta_0)}]  e^{im\theta} e^{in\theta}  e^{ik\theta} d\theta
=im[\pi e^{-i\theta_0}\delta_{m,-n-k-1}+\pi e^{i\theta_0}\delta_{m,-n-k+1}]
\end{aligned}
\end{equation}
...
\begin{equation}
\begin{aligned}
\Theta_{\{\alpha\}\beta}=\int_0^{2\pi} {\partial \over \partial s}(e^{im\theta}) e^{in\theta} d\theta
=2\pi im \delta_{m,-n}
\end{aligned}
\end{equation}
