...
Finally, we obtain two equations involving just pressure and longitudinal velocity modes:

\begin{equation}
\begin{aligned}
{u'}_\alpha^a+M_{\alpha\beta}^a p_\beta^a + G_{\alpha\beta}^a u_\beta^a=\mathcal{A}[u,u]+\mathcal{B}[p,p]+\varepsilon[u,p]\\
