...
\begin{equation}
\begin{aligned}
\uuline{{d \over ds} V_\alpha^a=\int_0^{2\pi}{{h'}^2\over {1-\kappa h cos\phi}}[r \psi_\beta \psi_\alpha ]_0^h d\theta U_\beta^a +\Psi_{\{\alpha\}\beta}[r]V_\beta^a=\int_0^{2\pi}{{h'}^2\over {1-\kappa h cos\phi}}[r \psi_\beta \psi_\alpha ]_0^h d\theta U_\beta^a -G_{\alpha\beta}^a V_\beta^a}\\
\end{aligned}
\end{equation}
...
:=\Psi_{\alpha\beta\gamma}[r]\sum_{b=-\infty}^{+\infty}([{(\textbf{M}p)_\beta^{a-b}+(\textbf{G}u)_\beta^{a-b}]V_\gamma^{b}}+[\int_0^{2\pi}{{h'}^2\over {1-\kappa h cos\phi}}[r \psi_\beta \psi_\alpha ]_0^h d\theta U_\beta^a-G_{\alpha\beta}^a V_\beta^a]U_\beta^{a-b})\\
...
+\sum_{b=-\infty}^{+\infty}\Psi_{\alpha\beta\gamma}[r](\int_0^{2\pi}{{h'}^2\over {1-\kappa h cos\phi}}[r \psi_\beta \psi_\alpha ]_0^h d\theta )u_\beta^{a-b}u_\gamma^{b}\rightarrow\mathcal{A}_{2.1}\\
