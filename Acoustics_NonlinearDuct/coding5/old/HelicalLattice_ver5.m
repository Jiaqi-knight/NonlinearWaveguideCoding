...
figure;view([-22 19.6]);
if kappa~=0
    [x,y,z,t]=tubeplot(mastX,mastY,mastZ,h,s,50);
else
    %[x,y,z,t]=cylplot(mastX,mastY,mastZ,h,s,50);

end
% 
figure;
plot3(mastX,mastY,mastZ);hold on;
plot3(mastX(1), mastY(1), mastZ(1),'r*');
